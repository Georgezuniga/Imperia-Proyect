...
import { createRun, myRuns, getRun, upsertEntry, submitRun, getRunStatus } from "../controllers/checkRunsController.js";
...
router.post("/:runId/entries", authRequired, uploadPhoto.single("photo"), upsertEntry);
